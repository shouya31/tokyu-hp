<template>
    <div class="container-fuild people grid grid-cols-1 lg:grid-cols-4 gap-4 md:gap-9 lg:gap-7">
        ...
        <!-- 質問回答セクション -->
        <section class="question col-span-3 col-start-2 lg:flex pt-0 pr-5 xl:pt-30 h-full">
        ...
        <section class="question col-span-3 col-start-2 lg:flex xl:pt-8 pt-0 pr-5 h-full">
        ...
        <section class="answer col-span-3 col-start-2 w-3/5 mx-auto py-5 pr-5 h-full">
        ...
        <section class="column col-span-4 lg:col-span-3 lg:col-start-2 lg:pt-10 lg:pr-5 px-10">
            <div class="upper-content bg-indigo-900 text-white text-center w-1/2 xl:w-1/5 py-2 relative lg:right-12 top-20">
                <h5 class="font-thin text-xl md:text-3xl column-lead">Column</h5>
            </div>
            ...
            <div class="bottom-content xl:w-4/5 bg-white text-center xl:py-7 pt-10">
                <h6 class="column-title underline pb-3 pt-12 font-extralight text-2xl md:text-4xl font-thin tracking-widest">東急線と共に歩む</h6>
