    ...
    <section class="faq-contents mx-auto">
      ...
      <div class="">
        ...
        <dl class="listQA">
          ...
          <dd>
            <p>
              東京地区採用と北海道地区採用に分かれており、選考フローも異なります。原則、東京地区にて採用された方は東京・神奈川の事業所、北海道地区で採用された方は北海道が勤務地になります。
            </p>
            <p class="mt-4">
              ※詳細は<a href="/recruit" target="_blank">募集要項</a
              >をご確認ください。
            </p>
          </dd>
        </dl>
      ...
      <div class="">
        ...
        <dl class="listQA">
          ...
          <dd>
            <p>
              平均7.6時間/月（※2019年度実績）と、全国的な平均と比べても低く、仕事とプライベートの両立もしやすいです。
            </p>
            <p class="mt-4">
        ...
        <dl class="listQA">
          ...
          <dd>
            <p>
              ...
              有給取得日数は平均11.9日/年（※2019年度実績）と、社員が休暇を取得しやすい風土づくりにも取り組んでいます。
            </p>
            <p class="mt-4">
              ※2020年度は新型コロナウイルスの影響を受け、例年と異なる数値傾向となったため、2019年度実績を記載しています。
            </p>
