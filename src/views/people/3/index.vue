  ...
  <div class="people lg:grid grid-cols-1 lg:grid-cols-12 overflow-hidden">
        ...
        <ul class="employee-box lg:mt-16">
          ...
          <li>
            <p class="people-info mt-3 tracking-wide">
              ...
              ><span class="mx-2 lg:mx-3">/</span> 2008年 入社
            </p>
          </li>
        </ul>
      </div>
    ...
    >
      ...
      <p class="answer-text tracking-widest">
        学生時代は、主に映画館スタッフのアルバイトを経験。就職活動においても、お客様と直接関わりの持てる仕事に就きたいと考え、百貨店業界を志望しました。その上で、他の百貨店と比べ、人数を絞り、採用を行っていた東急百貨店に社員一人ひとりへの期待値の高さを感じました。また、電車の遅延により、面接に遅れる旨をお伝えした際に「安全に配慮してお越しください」と親身にご対応いただけたことから社員の人柄の良さを実感し、入社を決めました。
      </p>
    </section>
    ...
    >
      ...
      >
        ...
        <div>
          <p class="answer-text tracking-widest">
            現在は婦人服バイヤーとして、*出店テナントとの販売施策に関する打ち合わせや*リーシングを主な業務としています。その他にも、最近ではSNSを通じたキャンペーン周知や取引先から提案されるデジタル施策の導入に向け、テナントと関係部署をつなぐ仲介役としても機能。職域が広いことでプレッシャーを伴う一方、仕入れた商品をお客様にご購入いただけた際や店舗担当者から商品に対する良い反応が得られた際は、達成感を感じます。
          </p>
    ...
    >
      ...
      <div class="people-answer-box right-content w-screen pb-5 md:w-3/5">
        ...
        <p class="answer-text tracking-widest">
          第一に、東急百貨店をご利用くださるお客様への感謝を忘れることなく、一人ひとりに合わせた接客を継続していきたいです。また、リアルからオンラインへの移行、実店舗を介した*CtoC販売など進歩を続ける社会。そうした変化にいち早く対応できる百貨店であるために、日々お客様のニーズや行動に目を配り、成長を模索していければと考えています。私たちの成長がお客様のためになると信じています。
        </p>
      </div>
    </section>
    ...
    >
      ...
      <section class="">
        ...
        <div class="column-content bg-white text-center pt-20">
          ...
          <p class="column-text">
            コロナ禍での休業により、予定したイベントや仕入れた商品が日の目を見ず、不安が募っていました。そんな中でお取引先様からいただいた「来期に向けた前向きな話がしたい」とのご連絡。どんな時も頼りにしてくださるお取引先様がいることを嬉しく思うと共に、お取引先様のためにも、常にベストを尽くしたいと改めて感じました。
          </p>
        </div>
      </section>
      <!-- コラムここまで -->
